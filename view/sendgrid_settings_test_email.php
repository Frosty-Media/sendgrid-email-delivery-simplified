      ...
      <table class="form-table">
        <tbody>
          ...
          <tr valign="top">
            ...
            <td>
              <input type="text" name="sendgrid_to" required value="<?php echo isset( $success ) ? '' : (isset( $to ) ? $to : '') ; ?>" size="20" class="regular-text">
            </td>
          </tr>
          <tr valign="top">
            <th scope="row"><?php _e("Subject: "); ?></th>
            <td>
              <input type="text" name="sendgrid_subj" required value="<?php echo isset( $success ) ? '' : (isset( $subject ) ? $subject : '') ; ?>" size="20" class="regular-text">
            </td>
          </tr>
          <tr valign="top">
